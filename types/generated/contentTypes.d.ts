...
export interface ApiAiCharacterAiCharacter extends Struct.CollectionTypeSchema {
  collectionName: 'ai_characters';
  info: {
    displayName: 'AI Character';
    pluralName: 'ai-characters';
    singularName: 'ai-character';
  };
  options: {
...
export interface ApiChatConversationChatConversation
  ...
  attributes: {
    ai_character: Schema.Attribute.Relation<
      'oneToOne',
      'api::ai-character.ai-character'
    >;
    ...
    > &
      Schema.Attribute.Private;
    message_id: Schema.Attribute.UID & Schema.Attribute.Required;
    message_status: Schema.Attribute.Enumeration<['sent', 'read']> &
